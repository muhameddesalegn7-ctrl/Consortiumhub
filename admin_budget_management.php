...
<body>
                ...
                <form method="POST" action="admin_fields_handler.php">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="text" 
                                id="edit_budget_data_category_name" 
                                name="category_name" 
                                class="form-input" 
                                required
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="text" 
                                id="edit_budget_data_period_name" 
                                name="period_name" 
                                class="form-input" 
                                required
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="date" 
                                id="edit_budget_data_start_date" 
                                name="start_date" 
                                class="form-input"
                                required
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="number" 
                                step="0.01"
                                id="edit_budget_data_view_actual" 
                                name="actual" 
                                class="form-input bg-gray-100"
                                readonly
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="number" 
                                step="0.01"
                                id="edit_budget_data_view_forecast" 
                                name="forecast" 
                                class="form-input bg-gray-100"
                                readonly
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="number" 
                                step="0.01"
                                id="edit_budget_data_view_actual_plus_forecast" 
                                name="actual_plus_forecast" 
                                class="form-input bg-gray-100"
                                readonly
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="number" 
                                step="0.01"
                                id="edit_budget_data_view_variance_percentage" 
                                name="variance_percentage" 
                                class="form-input bg-gray-100"
                                readonly
                            >
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                type="text" 
                                id="edit_budget_data_view_certified" 
                                class="form-input bg-gray-100"
                                readonly
                            >
                        </div>
    ...
    <script>
        ...
        function saveEditBudgetData() {
            const form = document.getElementById('editBudgetDataForm');
            const formData = new FormData(form);
            
            fetch('admin_fields_handler.php?action=edit_budget_data', {
                method: 'POST',
                body: formData
            })
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                        ...
                        // Close the modal
                        closeEditBudgetDataModal();
                        // Reload the budget data table or refresh the page
                        window.location.reload();
                    } else {
                        alert('Error updating budget data: ' + data.message);
                    }
                })
                .catch(error => {
                    alert('Error updating budget data: ' + error);
                });
        }
