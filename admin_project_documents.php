...
if (!empty($filter_search)) {
    $sql .= " AND (cluster LIKE ? OR document_type LIKE ? OR progress_title LIKE ? OR challenge_title LIKE ? OR success_title LIKE ? OR uploaded_by LIKE ?)";
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['progress_title'] ?? $row['challenge_title'] ?? $row['success_title'] ?? 'N/A') ?></td>
                                        <td>
                                            <?php
                                            $fileCount = 0;
