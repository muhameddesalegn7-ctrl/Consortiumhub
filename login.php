...
<body class="min-h-screen flex items-center justify-center bg-animated p-4">
  <div class="login-card rounded-xl p-8 w-full max-w-md">
    ...
    <div class="mt-6 text-center">
      <button id="infoToggle" class="text-blue-600 text-sm font-medium flex items-center justify-center mx-auto">
    ...
    <div id="infoPanel" class="info-panel mt-4 bg-blue-50 p-4 rounded-lg text-sm text-gray-600">
      <p class="font-medium mb-3 text-blue-700 text-center">Default Login Credentials</p>
      
      <div class="grid grid-cols-1 gap-3">
        <div class="bg-white p-3 rounded border border-blue-100">
          <p class="font-semibold text-blue-800">Admin Account:</p>
          <div class="flex justify-between mt-1">
            <span class="text-gray-500">Email:</span>
            <span class="font-mono">admin@gmail.com</span>
          </div>
          <div class="flex justify-between mt-1">
        ...
        <div class="bg-white p-3 rounded border border-blue-100">
          <p class="font-semibold text-blue-800">Finance Officer:</p>
          <div class="flex justify-between mt-1">
            <span class="text-gray-500">Email:</span>
            <span class="font-mono">finance@woldiya.com</span>
          </div>
          <div class="flex justify-between mt-1">
            <span class="text-gray-500">Password:</span>
            <span class="font-mono">1234</span>
      ...
      <p class="mt-3 text-xs text-gray-500 text-center">After logging in as admin, you can manage users and clusters from the Admin panel.</p>
    </div>
  </div>
